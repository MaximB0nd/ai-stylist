...
2. рассчитать оценку новизны относительно истории;
...
6. после успешной генерации сохранить выбранный комплект в истории.
...
### 1.6. Как проверить модель ИИ-стилиста
